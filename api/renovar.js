// api/renovar.js  ·  VERSION 2  ·  Renueva la fecha de un servicio en Firestore (escritura segura)
//
...
export default async function handler(req, res) {
  if (req.method !== "POST")
    return res.status(200).json({ ok: true, version: 2, msg: "renovar v2 activo. Usá POST." });

  const { secret, clienteNorm, telefono, plataforma, dias, fechaActual, fechaExacta } = req.body || {};
