// api/tmdb.js  ·  VERSION 2  (buscador con reporte de errores)
...
export default async function handler(req, res) {
  if (req.method !== "POST") return res.status(200).json({ ok: true, version: 2, msg: "tmdb v2 activo. Usá POST para buscar." });
