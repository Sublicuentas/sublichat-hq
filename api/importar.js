...
async function handler(req, res) {
  ...
  if (req.method === "GET" || req.method === "HEAD") return res.status(200).json({ ok: true, version: "importar-sec-NESTEDFIX-FINAL-20260705", msg: "api/importar activo (filas como texto, sin arrays anidados)", acciones: ["sec_estado","sec_leer","sec_hoja_iniciar","sec_hoja_bloque","sec_finalizar","sec_hoja_leer"] });
