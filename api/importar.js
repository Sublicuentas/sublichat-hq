...
async function secBackupListar(db, body) {
  ...
  for (const d of snap.docs) {
    ...
    const key = String(x.seccion || "") + "__" + String(x.dateKey || String(x.createdAt || "").slice(0, 10));
